...
4. **Combine** the four resulting submatrices (`C11`, `C12`, `C21`, `C22`) into the final product matrix `C`.
5. **Display** the resulting multiplied matrix and **stop** the program.  

## Program:
```
Program to implement strassen matrix multiplication
...
## Output:
<img width="973" height="808" alt="image" src="https://github.com/user-attachments/assets/44514d0a-8f15-4a10-90b9-43ba1929b7b2" />
